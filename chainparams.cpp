...
{
    const char* pszTimestamp = "mingxing blockchain publish in 2020";
...
public:
    CMainParams() {
        ...
        consensus.nSeniorityHeight1 = 262800; 
        consensus.nSeniorityLevel1 = 0.35;
        consensus.nSeniorityHeight2 = 262800 * 2.5; 
        ...
        consensus.nPowTargetSpacing = 2 * 60; // Vircles: 2 minute
        ...
        genesis = CreateGenesisBlock(1603339200, 1827838, 0x1e0fffff, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000c55acfe893ecbb2eab00afa2fd2839cc35a557509b693b653c0020e15e6"));
        assert(genesis.hashMerkleRoot == uint256S("0x59159b2dcf1f82a0c6fe7362a4143bad60ac87af0d9a29785b8e0377b9f4742d"));

        vSeeds.emplace_back("101.37.21.143");
        vSeeds.emplace_back("118.178.56.18");
        vSeeds.emplace_back("116.62.53.93");
        ...
        //add by luke
        // Performance Fund -->Transfer Fund
        // strPerformanceAddr = "Sk7SxtCvuh1C8G4DDv2BX9JafX8hrTKqyY";
        // nPerformancePercent = 86;

        strTransferAddr = "SbQsWnxrDM1G5FNcw7vDiXjK2aE2N6scmz";
        nTransferPercent = 86;
        ...
        checkpointData = {
            {
                ...
                { 0, uint256S("0x00000c55acfe893ecbb2eab00afa2fd2839cc35a557509b693b653c0020e15e6")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1576000000, 280251, 0x1e0fffff, 1, 50 * COIN);
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000945db6d849b8ebf4c165f3bd3150a4023dbc056e5209aafcb5ae37fd7ad"));
        assert(genesis.hashMerkleRoot == uint256S("0x59159b2dcf1f82a0c6fe7362a4143bad60ac87af0d9a29785b8e0377b9f4742d"));
...
*/
        ...
        checkpointData = {
            {
                {0, uint256S("0x00000945db6d849b8ebf4c165f3bd3150a4023dbc056e5209aafcb5ae37fd7ad")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6378f59e698267b6dc3914d522ec8621486521694f53dfe488acc8c9758e49cf"));
        assert(genesis.hashMerkleRoot == uint256S("0x59159b2dcf1f82a0c6fe7362a4143bad60ac87af0d9a29785b8e0377b9f4742d"));
